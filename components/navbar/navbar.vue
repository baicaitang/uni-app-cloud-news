<template>
	<view class="navbar">
		<view class="navbar-fixed">
			...
			<!-- 导航栏内容 -->
			<view class="navbar-content" :class="{issearch:isSearch}" :style="{height:navbarHeight + 'px',width:windowWidth + 'px'}" @click.stop="open">
				...
				<view class="navbar-search" v-else>
					<!-- 搜索页的navbar -->
					<input type="text" class="navbar-search-text" v-model="val" @input="inputChange" placeholder="请输入搜索内容" />
				</view>
			</view>
		</view>
